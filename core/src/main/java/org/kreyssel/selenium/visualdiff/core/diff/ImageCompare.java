 ...
 * http://ooo.googlecode.com/svn/trunk/bean/qa/complex/ScreenComparer.java
 * 
 * 
 * @author kreyssel
 * 
...
public class ImageCompare {
	...
	public ImageCompare(final InputStream in1, final InputStream in2) throws IOException {
		int red = 0xff;
		int alpha = 0xff;
		diffColor = (alpha << 24);
	...
	public boolean compare() throws InterruptedException {
		...
		PixelGrabber pg = new PixelGrabber(img1.getSource(), 0, 0, w1, h1, pixels1, 0, w1);
		pg.grabPixels();

		int[] pixels2 = new int[w2 * h2];
		PixelGrabber pg2 = new PixelGrabber(img2.getSource(), 0, 0, w2, h2, pixels2, 0, w2);
		pg2.grabPixels();
	...
	public void saveDiffAsPng(final File file) throws IOException {
	...
	public void saveDiffAsPng(final OutputStream out) throws IOException {
