...
public class PrepareMojo extends AbstractMojo {
     ...
     * @param   screenshotDir   DOCUMENT ME!
     *
     * @throws  IOException
     */
    private void save( final File propertiesFile, final File screenshotDir ) throws IOException {

        propertiesFile.getParentFile().mkdirs();

        Properties props = new Properties();
        props.setProperty( ScreenshotManager.PROPERTY_OUTPUT_PATH, screenshotDir.getAbsolutePath() );
